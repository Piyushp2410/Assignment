...
<body>
    ...
    <div class="container bg-white border border-1 mt-5 p-4">
        <a href="" class="ms-5 p-5" style="text-decoration: none; color: black;"><b>Login here</b></a>
    </div>
    <div class="container bg-white border border-1 mt-2 p-4 col-md-7">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <img src="https://www.helperinfo.com/usertemplate/img/Password-Recovery.jpg" class="w-75 ms-3">
            </div>
            <div class="col-md-7">
                <form method="post">
                    ...
                    <div class="mt-3"><b>Return to</b> <a href="login.html" style="margin-left: 15px;">Login</a></div>
                </form>
            </div>
        </div>
    </div>
